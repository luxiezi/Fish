...
public class DemoActivity extends BaseActivity
{
    ...
    protected void onCreate(@Nullable Bundle bundle)
    {
        ...
        mRateInfos.add(new RateInfo("外星币", "50.21", null, "20.22", "", "20.98", "2016-8-4 14:40:10"));
        mRateInfos.add(new RateInfo("测试数据", null, "10.01", "20.22", "30.22", "20.98", "2016-8-4 14:40:10"));
